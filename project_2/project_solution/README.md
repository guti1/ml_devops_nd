...
- [WandB reference](#Weights-and-Biases-reference)
...
### Weights and Biases reference

The pipeline executions were logged via WnB, please see the results [here](https://wandb.ai/guti1/nyc_airbnb)
